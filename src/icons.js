const paths = {
  ...
  mushroom: '<path d="M5 11a7 7 0 0 1 14 0H5ZM9 11v3c0 2-1 3-2 5h10c-1-2-2-3-2-5v-3M8 8h.01M13 6h.01M16 9h.01"/>',
  ...
  shirt: '<path d="m8 4 4 2 4-2 5 3-2 4-2-1v11H9V10l-2 1-2-4zM12 6v15"/>',
  pants: '<path d="M7 3h10l1 18h-5l-1-10-1 10H6zM7 7h10"/>',
  boots: '<path d="M5 3h6v11l3 3h4c2 0 3 1 3 3H5zM14 17v3M6 14h6M16 17v3"/>',
  raincatcher: '<path d="M4 5h16l-5 7v9H9v-9zM7 2v3M12 1v4M17 2v3"/>',
  raft: '<path d="M3 17h18l-2 4H5zM5 17V8h11M10 8V3l7 5z"/>',
  bike: '<circle cx="6" cy="17" r="4"/><circle cx="18" cy="17" r="4"/><path d="m6 17 4-8h4l4 8M10 9l4 8H6M13 6h4M9 9 7 6"/>',
  ore: '<path d="m4 16 3-9 6-4 6 5 1 9-5 4H8zM9 9l6 7M15 7l-5 10"/>',
  metal: '<path d="M5 8h14l2 10H3zM8 8l1-4h6l1 4"/>',
  fishing: '<path d="M6 3c8 0 9 7 5 11M6 3v18M11 14v4a2 2 0 0 0 4 0v-1"/>',
  lantern: '<path d="M8 7h8l2 14H6zM9 7V4h6v3M9 12h6v6H9z"/>',
  bottle: '<path d="M9 3h6v4l2 3v11H7V10l2-3z"/>',
  chest: '<path d="M3 8h18v12H3zM3 12h18M10 12h4v4h-4zM6 8V5h12v3"/>',
  workbench: '<path d="M3 9h18v4H3zM6 13v8M18 13v8M8 5h8v4"/>',
  roof: '<path d="m3 13 9-8 9 8M6 12v9h12v-9"/>',
  tower: '<path d="M5 21 8 8h8l3 13M7 15h10M6 21h12M8 8l4-5 4 5M9 11h6M4 21h4M16 21h4"/>',
