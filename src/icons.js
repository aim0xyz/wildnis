const paths = {
  ...
  lightning: '<path d="m13 2-8 12h7l-1 8 8-12h-7z"/>',
  ...
  bow: '<path d="M6 3a12 12 0 0 1 0 18M6 3v18M4 12h14M15 9l3 3-3 3"/>',
  arrow: '<path d="M3 12h14M12 7l5 5-5 5M17 12h4M3 12l3-2M3 12l3 2"/>',
  hammer: '<path d="m14 5 3-3 5 5-3 3M16 8 6 21l-3-3L14 6M11 4l3-2 6 6-2 3"/>',
  ...
  dive: '<path d="M12 4v15M6 13l6 6 6-6"/>',
  bubbles: '<circle cx="9" cy="15" r="4"/><circle cx="16" cy="8" r="3"/><circle cx="7" cy="5" r="1.5"/>',
  drop: '<path d="M12 2S5 10 5 15a7 7 0 0 0 14 0c0-5-7-13-7-13Z"/>',
  thermometer: '<path d="M9 14.8V5a3 3 0 0 1 6 0v9.8a5 5 0 1 1-6 0ZM12 8v9"/>',
  coat: '<path d="m8 4 4 2 4-2 4 4-3 3v10H7V11L4 8zM12 6v15"/>',
  raincatcher: '<path d="M4 5h16l-5 7v9H9v-9zM7 2v3M12 1v4M17 2v3"/>',
  raft: '<path d="M3 17h18l-2 4H5zM5 17V8h11M10 8V3l7 5z"/>',
