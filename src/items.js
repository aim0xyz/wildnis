...
export const ITEMS = {
  ...
  hammer: { name: 'Bauhammer', icon: 'hammer', type: 'tool', once: true },
...
export const RECIPES = [
  ...
  { out: 'hammer', cost: { holz: 3, stein: 1 }, desc: 'Gebäude abbauen und einen Teil der Materialien retten' },
...
export const HOTBAR_ORDER = [
  'hand', 'axt', 'spitzhacke', 'speer', 'hammer',
